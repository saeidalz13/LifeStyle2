...
import { PlanRecord, PlanRecords } from "../../assets/FitnessInterfaces";
...
import ModalUpdatePlanRecord from "../workoutHistory/ModalUpdatePlanRecord";

interface ModalWorkoutHistoryProps {
  show: boolean;
  onHide: () => void;
  planRecords: PlanRecords | "error" | "waiting";
  dayPlanId: string;
}
...
const ModalWorkoutHistory = (props: ModalWorkoutHistoryProps) => {
  ...
  if (props.planRecords !== "waiting" && props.planRecords !== "error") {
    props.planRecords.plan_records.forEach((planRec) => {
  ...
  return (
    <>
      <Modal
        ...
        centered
      >
        <Modal.Header className="bg-light text-info" closeButton>
